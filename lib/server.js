...
app.get("/v1/explorer/stack/:stack", (request, response) => {
    const stack = request.params.stack;
    const Liststack = ExplorerController.getexplorerStack(stack);
    response.json({ Stack: stack, Explorers:Liststack});
});
