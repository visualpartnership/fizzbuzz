...
app.get("/v1/explorers/stack/:lenguaje", (request, response) => {
    const tech = request.params.lenguaje;
    const explorersInStack = ExplorerController.getExplorersByStack(tech);
    response.json({stack: tech, explorers: explorersInStack});
});
