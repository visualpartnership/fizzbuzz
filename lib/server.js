...
app.get('/v1/explorers/stack/:tech',(request, response)=>{
    const technology = request.params.tech;
    const prueba = ExplorerController.getExplorersByStack(technology);
...
// const prueba = ExplorerController.getExplorersByStack("javascript");
