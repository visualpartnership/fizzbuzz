...
app.get("/v1/fizzbuzz/stack/:mission", (request, response) => {
    const mission = request.params.mission;
    const usernamesByStacks = ExplorerController.getExplorersStackByMission(mission);
    response.json({mission: mission, explorers: usernamesByStacks});
});
