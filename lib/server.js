...
app.get("/v1/explorers/stack/:stackvalue",(request,response)=>{
    const stack=request.params.stackvalue;
    const ExplorersWithStack=ExplorerController.getExplorersArrayByStack(stack);
