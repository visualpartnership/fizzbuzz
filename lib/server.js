...
app.get("/v1/explorers/stack/:stackjs", (request, response) => {
    const stack = request.params.stackjs
    const listExplorersByStack = ExplorerController.getExplorersByStack(stack);
    response.json({stack: request.params.stackjs, explorers: listExplorersByStack});
})
