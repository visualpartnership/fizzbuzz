...
app.get("/v1/explorers/stack/:stack", (request, response) => {
  const namestack = request.params.stack;
  const listStack = ExplorerController.getExplorersUsernamesByStack(namestack);
  response.json({ stack: namestack, explorers: listStack });
});
